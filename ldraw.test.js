...
// import { fromScaling, identity } from "./matrix.js";
...
//     const { triangles } = file.render({color: Color.CURRENT_COLOR_CODE,  transformation: fromScaling(2) });
...
//     const inverted = file.render({ color: Color.CURRENT_COLOR_CODE, transformation: identity, invert: true });
